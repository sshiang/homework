...
public abstract class Qry {
  ...
  public void appendWeight(double w) throws IllegalArgumentException {
	if ((!(this instanceof QrySopWSum)) && (!(this instanceof QrySopWAnd))) {
		throw new IllegalArgumentException
			("The operator doesn't support weights.");
	}
